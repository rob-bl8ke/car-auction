...
{
    // Create a scope to retrieve the DbContext which is already available
    // as an injectable service. Use it to add some seed data to the database.
    ...
    {
        // Create the database if it does not exist and apply the latest
        // migrations.
